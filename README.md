...
点击下表中的链接，可直接跳转至 Loon 应用并自动识别插件地址：

| 插件名称 | 功能描述 | 一键导入 (Loon) |
| :--- | :--- | :--- |
| **龙湖余量查询** | 自动监控电费余额并提醒 | [📥 点击导入](loon://import?plugin=https://raw.githubusercontent.com/wangyaoya/Tools/master/Loon/plugin/longHu/queryLongHuBalance.plugin) |
| **联通白名单** | 自动修改白名单接口返回码 | [📥 点击导入](loon://import?plugin=https://raw.githubusercontent.com/wangyaoya/Tools/refs/heads/master/Loon/plugIn/commonRewrite/unicom_official_white.plugin) |
| **湖北移动SSO** | 优化个人主页/账单跳转逻辑 | [📥 点击导入](loon://import?plugin=https://raw.githubusercontent.com/wangyaoya/Tools/refs/heads/master/Loon/plugIn/commonRewrite/hb10086_sso_jump.plugin) |
